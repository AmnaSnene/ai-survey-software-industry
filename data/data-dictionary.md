...
| 17 | What effect has AI had on the quality of your work? | integer 1–5 | 1 = Much worse … 5 = Much better |
| 18 | What effect has AI had on your learning and skill growth? | integer 1–5 | 1 = Much worse … 5 = Much better |
| 19 | Since using AI, do you feel more or less challenged by your work? | integer 1–5 | 1 = Much less challenged … 5 = Much more challenged |
| 20 | What effect has AI had on your motivation at work? | integer 1–5 | 1 = Much less motivated … 5 = Much more motivated |
| 21 | Has AI-generated output ever caused a bug or incident that reached production? | text | Yes, a serious incident · Yes, minor issues · No · Not sure · Not applicable · Prefer not to say |
| 22 | Do you review AI-generated code before using it? | text | Always · Usually · Sometimes · Rarely · Never · Not applicable · Prefer not to say · free text (Other) |
| 23 | How much of the AI-generated code do you actually read? | text | Every line · Most of it · I skim through it · Only the risky or critical parts · Almost none · Not applicable · Prefer not to say · free text (Other) |
| 24 | Does your team still do code reviews for AI-generated code? | text | Yes, same as for human-written code · Yes, but lighter than before · No, AI-generated code skips review · I don't have a team · Not applicable · Prefer not to say · free text (Other) |
| 25 | How do you test AI-generated code? (select all that apply) | text (multi) | I write and run unit tests · I run the existing test suite · Manual testing · I ask the AI to write tests for its own code · Code review only · I don't specifically test it · Not applicable · Prefer not to say · free text (Other) |
| 26 | Overall, what effect has AI had on collaboration within your team? | integer 1–5 | 1 = Much worse … 5 = Much better |
| 27 | Since using AI, how often do you ask colleagues for help? | text | Much less often · Less often · About the same · More often · Much more often · Not applicable · Prefer not to say |
| 28 | How has AI affected knowledge sharing in your team (mentoring, pair programming, asking questions)? | text | Greatly reduced it · Somewhat reduced it · No change · Somewhat increased it · Greatly increased it · Not applicable · Prefer not to say |
| 29 | Which best describes your organization's AI policy? | text | AI use is encouraged and funded · Allowed with restrictions · Allowed, but no official guidance · Discouraged or banned · There is no policy · I don't know · Not applicable · Prefer not to say |
| 30 | Does your organization provide AI training? | text | Yes, formal training · Yes, informal (tips, lunch & learns...) · No · I don't know · Not applicable · Prefer not to say |
| 31 | Which AI tools (if any) are explicitly banned where you work or study? | text | Free text; may be empty. |
| 32 | What are your biggest concerns about AI in software work? (select all that apply) | text (multi) | Security vulnerabilities · Data privacy / leaks · Intellectual property & licensing · Job displacement · Skill erosion · Over-reliance on AI · Incorrect output / hallucinations · Bias & ethics · Environmental impact · None of these · Prefer not to say |
| 33 | How worried are you about AI's impact on your job or career prospects? | integer 1–5 | 1 = Not worried at all … 5 = Extremely worried |
| 34 | In 3 years, how do you expect AI's role in your daily work to evolve? | text | It will shrink · It will stay about the same · It will grow somewhat · It will grow significantly · AI will perform most of my current tasks · Prefer not to say |
...
| 36 | What is the biggest change AI has made in the way you work? (optional) | text | Free text; may be empty. |
...
- Questions 9–31 are empty for respondents who answered "I tried, but stopped",
...
- **Edition history:** the survey was trimmed mid-edition based on respondent
  feedback. Early responses may contain up to 7 extra columns, removed for
  ...
  `If you could, would you go back to working without AI?`, and
