...
| 10 | Which one do you rely on the most? | text | Single value from `AI_TOOLS`, or `Other`. Empty for non-users. |
...
| 12 | Who pays for the AI tools you use? | text | My employer provides paid tools · I pay for them personally · I only use free tiers · A mix of employer and personal · Not applicable |
...
| 17 | Which task benefits the most from AI? | text | Single value from `TASKS`, or `Other`. |
...
| 23 | Since using AI, do you feel more or less challenged by your work? | integer 1–5 | 1 = Much less challenged … 5 = Much more challenged |
| 24 | What effect has AI had on how deeply you think about problems? | integer 1–5 | 1 = I think much less deeply … 5 = I think much more deeply |
| 25 | What effect has AI had on your motivation at work? | integer 1–5 | 1 = Much less motivated … 5 = Much more motivated |
| 26 | If you could, would you go back to working without AI? | text | Definitely not · Probably not · Not sure · Probably yes · Definitely yes · Not applicable |
| 27 | Has AI-generated output ever caused a bug or incident that reached production? | text | Yes, a serious incident · Yes, minor issues · No · Not sure · Not applicable |
| 28 | Do you review AI-generated code before using it? | text | Always · Usually · Sometimes · Rarely · Never · Not applicable · free text (Other) |
| 29 | How much of the AI-generated code do you actually read? | text | Every line · Most of it · I skim through it · Only the risky or critical parts · Almost none · Not applicable · free text (Other) |
| 30 | Does your team still do code reviews for AI-generated code? | text | Yes, same as for human-written code · Yes, but lighter than before · No, AI-generated code skips review · I don't have a team · Not applicable · free text (Other) |
| 31 | How do you test AI-generated code? (select all that apply) | text (multi) | I write and run unit tests · I run the existing test suite · Manual testing · I ask the AI to write tests for its own code · Code review only · I don't specifically test it · Not applicable · free text (Other) |
| 32 | Which best describes your organization's AI policy? | text | AI use is encouraged and funded · Allowed with restrictions · Allowed, but no official guidance · Discouraged or banned · There is no policy · I don't know · Not applicable |
| 33 | Does your organization provide AI training? | text | Yes, formal training · Yes, informal (tips, lunch & learns...) · No · I don't know · Not applicable |
| 34 | Which AI tools (if any) are explicitly banned where you work or study? | text | Free text; may be empty. |
| 35 | What are your biggest concerns about AI in software work? (select all that apply) | text (multi) | Security vulnerabilities · Data privacy / leaks · Intellectual property & licensing · Job displacement · Skill erosion · Over-reliance on AI · Incorrect output / hallucinations · Bias & ethics · Environmental impact · None of these |
| 36 | How worried are you about AI's impact on your job or career prospects? | integer 1–5 | 1 = Not worried at all … 5 = Extremely worried |
| 37 | In 3 years, how do you expect AI's role in your daily work to evolve? | text | It will shrink · It will stay about the same · It will grow somewhat · It will grow significantly · AI will perform most of my current tasks |
| 38 | If you do NOT currently use AI tools, why not? (select all that apply - skip if you use AI) | text (multi) | Company policy forbids it · Privacy or security concerns · Not useful for my work · Output quality concerns · Ethical concerns · Cost · I haven't had the chance to try · free text (Other). Usually empty for users. |
...
- Questions 9–34 are empty for respondents who answered "I tried, but stopped"
  or "No, never" in Q8 (they skip sections 2–6 by design).
