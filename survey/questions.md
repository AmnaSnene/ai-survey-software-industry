...
| 9 | Which AI tools do you use? (select all) | Checkboxes + "Other" | ChatGPT · GitHub Copilot · Claude · Google Gemini · Cursor · Windsurf / Codeium · Amazon Q Developer · Tabnine · JetBrains AI Assistant · Microsoft 365 Copilot · Perplexity · Claude Code · OpenAI Codex · Gemini CLI · Aider · Devin · OpenHands · Self-hosted / local models (Ollama, LM Studio…) · Prefer not to say | Yes | Market-share view of tools, including the agentic-CLI wave (Claude Code, Codex, Gemini CLI…). |
